...
@WebServlet(
        name = "RegistrationVhodServlet",
        urlPatterns = {"/RegistrationVhod"}
)

public class RegistrationVhodServlet extends HttpServlet{
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(s.equals(Obj.name) || s.equals(Obj.login) || s.equals(Obj.password) || y==Obj.age || y==Obj.weight || y==Obj.height)
        {
